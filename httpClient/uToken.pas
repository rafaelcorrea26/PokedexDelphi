unit uToken; // classe que gera e grava o token
...
begin
  ...
  try
    ...
    if (lQuery.RecordCount > 0) and (lQuery.FieldByName('ACCESS_TOKEN_EXPIRES').AsDateTime > now) then
    begin
      result := true;
